...
public class A2Tester {
	...
	public static void testMoneySpent() {
		...
		expected = 0;
		displayResults(result==expected, "amount "+bidderName+" spent at f10a null");

		bidderName = new String("Ali");
		result = f0b.moneySpent(bidderName);
		expected = 0;
		displayResults(result==expected, "amount "+bidderName+" spent at f0b empty");
	...
	public static void testMostExpensive() {
		...
		Fundraiser f0 = new Fundraiser("big soup time", arr0);
		Fundraiser f1 = new Fundraiser("Family Fundraiser", arr1);
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
	...
	public static void testAddToFundraiser() {
		...
		f0.addToFundraiser(a7);
		result = f0.getItems();
		expected = extra;
		displayResults(equal(result,expected), "added a7 to f0");

		f1.addToFundraiser(a7);
		result = f1.getItems();
		expected = extra;
		displayResults(equal(result,expected), "added a7 to f1");
