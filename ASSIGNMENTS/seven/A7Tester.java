...
public class A7Tester {
	...
	public static boolean testRandomArray (int count)
	{
		...
		*/
		...
		while (!q.isEmpty()) {
			...
			//System.out.println("was "+ oldVal + " is " + val);
			 
			if ( val < oldVal ) {
				//System.out.println(i);
				//System.out.println("is less than "+ oldVal + " is " + val);
				return false;
			}
			oldVal = val;
			i++;
	...
	public static void testConcertLine() {
		...
		smallVenue.nextAttendee();
		smallVenue.nextAttendee();
		Attendee result = smallVenue.nextAttendee();
		displayResults(result == null, "testing ConcertLine addAttendee to full line - should get here without exception");
