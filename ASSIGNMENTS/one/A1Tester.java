...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		result = A1Exercises.greatestCommonDenominator(8, 6);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		result = A1Exercises.greatestCommonDenominator(5, 7);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(5, 5);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(array0, 1)");
		result = A1Exercises.countMatches(array0, 1);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		System.out.println("Testing countMatches(array2, 8)");
		result = A1Exercises.countMatches(array2, 8);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(array3, -1)");
		result = A1Exercises.countMatches(array3, -1);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
